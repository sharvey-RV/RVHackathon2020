...
//This lambda works as a proxy to connect to the other lambda called executecommand (with VPC) 
//to be able to access the RDS database which is in the same VPC
